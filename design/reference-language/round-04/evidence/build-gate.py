"""Serialize P6 human review decisions; this does not judge images automatically."""
import hashlib
...
for item in items:
 ...
 scope=EX[rid][0] if rid in EX else 'P6 저장/테마/정보구조영향과 P5 변경없는모바일카페/예약기준'
