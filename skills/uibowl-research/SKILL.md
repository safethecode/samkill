...
설계·구현에 사용할 실제 이미지를 확보하면 제품 각색 전에 [reference-decompose](../reference-decompose/SKILL.md)로 요소·관계·프롬프트 입력을 정리한다. 기존 E/O/Q 기록은 재사용하며 검색 결과만 요청한 범위에 구현 실험을 추가하지 않는다.
